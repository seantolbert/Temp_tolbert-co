            ...
            <div className="vertical-center">
              <div className="started-content">
                <h1 className="h-title">
                  Hello, I’m <strong>Sean Tolbert</strong>, React Developer
                  and <br />
                  AWS - Python Automator Based in Washington, DC.
                </h1>
            ...
            <div className="desc">
              ...
              <div className="info-list">
                <ul>
                  ...
                  <li>
                    <strong>E-mail:</strong> Seana@gmail.com
                  </li>
                </ul>
              </div>
              <div className="bts">
            ...
            <div className="team-items">
              <div className="team-col">
                <div className="team-item content-box">
                  ...
                  <div className="desc">
                    <div className="name">Sean Tolbert</div>
